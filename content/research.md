...
title: "Research"
layout: "research"
description: "Research projects by Makoto P. Kato, organized by funded research programs: client-side information retrieval, low-resource IR, data search, and more."
intro: >
  My research projects, organized by the research programs that have funded
  them and loosely grouped into ongoing and concluded lines. Each project
  lists closely related publications; datasets and tools are available on the
  Data & Tools page. The diagrams are schematic illustrations of each
  project's idea.
projects:
  - id: "client-side-ir"
  ...
  - id: "ir-evaluation"
    ...
    summary: >
      ...
      develop evaluation methodologies for information access systems,
      including online evaluation based on interleaving and multileaving. We
      have organized NTCIR tasks such as INTENT, 1CLICK, MobileClick,
      OpenLiveQ, and Data Search.
    publications:
  ...
  - id: "data-search"
    ...
    status: "past"
    period: "2018 – 2025"
    funding: "JST PRESTO (FY2018–FY2021) / JSPS KAKENHI (B) (FY2018–FY2022)"
    image: "/images/projects/data-search.svg"
    summary: >
      This line aims to develop a data search engine for organizing the
      world's open data and making it universally accessible and useful,
      providing flexible access to open data through an index built by data
      analysis. It also includes evidence-based information retrieval —
      matching natural-language texts with data and knowledge bases to verify
      the credibility of information and to rank entities by their properties —
      supporting open science and data-driven decision making.
    publications:
  ...
  - id: "information-need-elicitation"
    title: "Information Need Elicitation & Search Behavior"
    status: "past"
    period: "2012 – 2023"
    funding: "JSPS KAKENHI Young Scientists (A) (FY2014–FY2017)"
    image: "/images/projects/information-need-elicitation.svg"
    summary: >
      We studied how to elicit information needs from users — using sensors,
      brain signals, and search behaviors such as clicks to estimate desired
      information actively and effectively — together with broader analyses of
      user search behavior, from query suggestion to online purchase behavior.
    publications:
  ...
  - id: "analogy-based-ir"
    ...
    summary: >
      ...
      geographic search that lets users search unfamiliar places as if they
